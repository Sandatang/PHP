...
<div class="mx-auto max-w-7xl pt-8 mt-2 flex flex-col items-center justify-center">
    ...
    <div class=" pt-4 w-3/4 max-h-[400px] overflow-hidden flex flex-col shadow-lg shadow-gray-400  justify-center items-center">
        <h2><?php include('../includes/message.php'); ?></h2>

        <table class="text-[13px] w-full border- border-slate-400">
            <thead>
                <tr>
                    <td class="border border-slate-400 uppercase font-bold">Employee no.</td>
                    <td class="border border-slate-400 uppercase font-bold">First name</td>
                    <td class="border border-slate-400 uppercase font-bold">Last name</td>
                    <td class="border border-slate-400 uppercase font-bold">Middle name</td>
                    <td class="border border-slate-400 uppercase font-bold">Position</td>
                    <td class="border border-slate-400 uppercase font-bold">Department</td>
                    <td class="border border-slate-400 uppercase font-bold text-center" colspan="2">Action</td>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                ?>
                    ...
                    ?>
                    <tr>
                        <td class="border border-slate-400 " colspan="7">No records</td>
                    </tr>
                <?php
                }
